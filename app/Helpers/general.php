...
if (!function_exists('get_logo')) {
    function get_logo() {
        ...
        if ($logo == "") {
            return public_asset("backend/images/company-logo.png");
        }
        return public_asset("uploads/media/$logo");
    }
}
...
if (!function_exists('get_favicon')) {
    function get_favicon() {
        ...
        if ($favicon == "") {
            return public_asset("backend/images/favicon.png");
        }
        return public_asset("uploads/media/$favicon");
    }
}
...
if (!function_exists('profile_picture')) {
    function profile_picture($profile_picture = '') {
        ...
        if ($profile_picture == '') {
            return public_asset('backend/images/avatar.png');
        }

        return public_asset('uploads/profile/' . $profile_picture);
    }
}
