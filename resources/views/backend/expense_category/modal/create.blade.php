<link href="{{ public_asset('backend/plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.css') }}" rel="stylesheet">
...
<script src="{{ public_asset('backend/plugins/bootstrap-colorpicker/bootstrap-colorpicker.js') }}"></script>
