                    ...
                    <table class="table table-bordered mt-4">
                        ...
                        @if(! $customFields->isEmpty())
                            ...
                            <td>
                                    ...
                                    {!! $file != null ? '<a href="'. public_asset('public/uploads/media/'.$file) .'" target="_blank" class="btn btn-xs btn-outline-primary"><i class="far fa-eye mr-2"></i>'._lang('Preview').'</a>' : '' !!}
                                    @else
                        ...
                        <tr>
                            ...
                            <td>
                                {!! $loan->attachment == "" ? '' : '<a href="'. public_asset('public/uploads/media/'.$loan->attachment) .'" target="_blank">'._lang('Download').'</a>' !!}
                            </td>
                        </tr>
