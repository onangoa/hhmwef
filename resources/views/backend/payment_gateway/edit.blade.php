					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="image" data-allowed-file-extensions="png jpg" data-default-file="{{ public_asset('backend/images/gateways/'.$paymentgateway->image) }}">
							</div>
						</div>
