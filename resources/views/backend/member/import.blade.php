                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ol class="pl-3">
                                ...
                                <li>{{ _lang('The first row should either be left blank or used exclusively for column headers.') }}</li>
                                <li>{{ _lang('A required field must be present; otherwise, the entire row will be ignored.') }}</li>
                                <li><a href="{{ public_asset('import_sample/members.xlsx') }}">{{ _lang('Download Sample File') }}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
