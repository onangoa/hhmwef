					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="image" data-default-file="{{ $depositmethod->image != null ? public_asset('public/uploads/media/'.$depositmethod->image) : public_asset('backend/images/no-image.png') }}">
							</div>
						</div>
